...
export const SEARCH_URL = (text) => {
    return `https://api.themoviedb.org/3/search/movie?api_key=eeadb5c738acc57bdc5851ce777d00bb&language=en-US&page=1&include_adult=false&query=${text}`
}
